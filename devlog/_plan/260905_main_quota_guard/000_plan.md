...
- Off/absent flag preserves current routing. Enabled flag blocks observed main usage >=99 across relevant non-expired windows, including short-only observations. Unknown data is not invented as 0 or 100.
